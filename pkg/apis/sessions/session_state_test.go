...
func TestString(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expected: "Session{email:email@email.email user:some.user PreferredUsername:preferred.user Username:some.user refresh_token:false}",
		},
		{
			name: "Full Session",
			sessionState: &SessionState{
		...
		},
		{
			...
			expected: "Session{email:email@email.email user:some.user PreferredUsername:preferred.user Username:some.user created:2000-01-01 00:00:00 +0000 UTC refresh_token:false}",
		},
		{
			...
			expected: "Session{email:email@email.email user:some.user PreferredUsername:preferred.user Username:some.user expires:2000-01-01 01:00:00 +0000 UTC refresh_token:false}",
		},
		{
			...
			expected: "Session{email:email@email.email user:some.user PreferredUsername:preferred.user Username:some.user token:true refresh_token:false}",
		},
		{
			...
			expected: "Session{email:email@email.email user:some.user PreferredUsername:preferred.user Username:some.user id_token:true refresh_token:false}",
		},
		{
